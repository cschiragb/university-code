 ...
 *  
 *  The Employee class and the interface Payable have been updated such that
 *  the salary of an employee is now of type Double, see paymentAmount()
 *  below.
 *
 *  @version 2018-12-06
...
public abstract class Employee implements Payable, Holiday {
    ...
    /**
     * The abstract method needs implementation in each concrete
     * sub-class
     * @param rate is the percentage increase of the salary to be applied
     */
