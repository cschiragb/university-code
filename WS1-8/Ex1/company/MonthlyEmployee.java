 ...
 *  
 *  The class has been updated to set the monthly employee salary i.e.
 *  paymentAmount() to type Double.
 *  The corresponding getter and setter for monthlySalary have also 
...
public class MonthlyEmployee extends Employee{
    ...
    public void increaseSalaries(double rate) {
    	setMonthlySalary(getMonthlySalary() * (1 + (rate/100.0)));
    }
}
