 ...
 *  
 *  The class has been updated to set the hourly employee salary i.e.
 *  paymentAmount() to type Double.
 *  The corresponding getter and setter for hourlySalary have also 
 *  been updated to type Double. 
 *  
 *  The toString method has also been updated to match the format of the
 *  toString for a monthlyEmployee. Thereby allowing a list of employees
 *  in a Company to be printed more clearly.
 *  
 *  @version 2018-12-06
...
public class HourlyEmployee extends Employee { 
    ...
    public String toString() {
        return "HourlyEmployee [" + super.toString() + "hourlySalary= " + getHourlySalary() + " Hours worked: " + getWorkedHoursLastMonth() 
        		+ " Month's salary: " + paymentAmount() + "]";
    }
    ...
    public void increaseSalaries(double rate) {
    	setHourlySalary(getHourlySalary() * (1 + (rate/100.0)));
    }
