 ...
 *   
 *   The class was modified to provide a getter for the year, to allow
 *   for checks to be made in the Booking Class. See bottom of the 
 *   class just above the main method.
 *   
 *   @version 2018-12-06
...
public class Date {
    ...
    /**
     * 
     * @return the year of the date in question as type int
     */
    public int getYear() {
    	return year;
    }
